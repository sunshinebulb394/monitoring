    ...
    <div className="w-full  row-span-9  h-full">
      <Tabs defaultValue="account" className="grid grid-rows-12">
        <TabsList className="grid grid-cols-12">
          <TabsTrigger value="account" className="col-span-3 ">
            Account
          </TabsTrigger>
          <TabsTrigger value="password" className="col-span-3 ">
            Password
          </TabsTrigger>
        </TabsList>
        <TabsContent
          value="account"
          className="grid xs:grid-rows-2 sm:grid-cols-3 gap-x-3 gap-y-2 row-span-11 border"
        >
          <ChartProvider>
